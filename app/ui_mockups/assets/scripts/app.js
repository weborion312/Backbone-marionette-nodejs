...
//        $(".tasklist").before($(".taskDescription"));
//    }else{
//        var windowSize = 'big'
//    }
      $( window ).resize( function(){
          if($('.taskDescription').css('display') != 'none'){
              $('.task-body').css('height', ($('.taskDescription').height()-140)+'px')
          }
      })
//
//    $( window ).resize( function(){
//        if(window.innerWidth < 992 && windowSize === 'big'){
//            windowSize = 'small'
//            $(".tasklist").before($(".taskDescription"));
//        }
//        if(window.innerWidth > 992 && windowSize === 'small'){
//            windowSize = 'big'
//            $(".taskDescription").before($(".tasklist"));
//        }
//
//    })
    ...
    $('.showTask').on('click', function(){
        if($('.tasklist').hasClass('tasklistOpen')){
            $('.tasklist').removeClass('tasklistOpen')
            $('.taskDescription').removeClass('taskOpen')
            $('.task-body').css('height', 'auto')
        }else{
            $('.tasklist').addClass('tasklistOpen')
            $('.taskDescription').addClass('taskOpen')
            $('.task-body').css('height', $('.taskDescription').height()-140+'px')
